...
public static get hotelDetails(): string {
  return this.hotel + '/course-details';
}
public static get hotelBooking(): string {
  return this.hotel + '/course-purchase';
}
...
public static get becomeAnExpert(): string {
  ...
  public static get becomeAnStudent(): string {
    return  this.pages + '/become-an-student';
  }
...
public static get teacherDashboard(): string {
  return this.user + '/teacher-dashboard';
}
public static get certificationManagement(): string {
  return this.user + '/certification-management';
}
...
public static get agentListings(): string {
  return this.agent + '/listings';
}
public static get agentHotelBooking(): string {
  return this.agent + '/hotel-booking';
}
